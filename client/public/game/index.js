  ...
  return async function (moduleArg = {}) {
    ...
    (function () {
      ...
      if (currentSafariVersion < 150200) {
        throw new Error(
          `This emscripten-generated code requires Safari v${packedVersionToHumanReadable(150200)} (detected v${currentSafariVersion})`,
        );
      }
      ...
      if (currentFirefoxVersion < 100) {
        throw new Error(
          `This emscripten-generated code requires Firefox v100 (detected v${currentFirefoxVersion})`,
        );
      }
      ...
      if (currentChromeVersion < 95) {
        throw new Error(
          `This emscripten-generated code requires Chrome v95 (detected v${currentChromeVersion})`,
        );
      }
    })();
    ...
    function findWasmBinary() {
      return locateFile('godot.web.template_release.wasm32.nothreads.wasm');
    }
    ...
    var _emscripten_webgl_do_create_context = (target, attributes) => {
      ...
      if (
        ...
        err(
          `Invalid WebGL version requested: ${contextAttributes.majorVersion}`,
        );
      }
      var canvas = findCanvasEventTarget(target);
      if (!canvas) {
    ...
    var GodotAudio = {
      ...
      start_sample: function (
        ...
        GodotAudio.SampleNode.create(
          { busIndex, id: playbackObjectId, streamObjectId },
          startOptions,
        );
      },
    ...
    function _godot_audio_sample_register_stream(
      ...
      GodotAudio.Sample.create(
        { id: streamObjectId, audioBuffer },
        { loopBegin, loopEnd, loopMode, numberOfChannels, sampleRate },
      );
    }
    ...
    var GodotInput = {
      ...
      onKeyEvent: function (pIsPressed, pEvent) {
        if (GodotInput.inputKeyCallback == null) {
          throw new TypeError(
            'GodotInput.onKeyEvent(): GodotInput.inputKeyCallback is null, cannot process key event.',
          );
        }
        if (GodotInput.setInputKeyData == null) {
          throw new TypeError(
            'GodotInput.onKeyEvent(): GodotInput.setInputKeyData is null, cannot process key event.',
          );
        }
        ...
        function create(what) {
          ...
          if (what === 'input') {
            ...
            GodotEventListeners.add(
              elem,
              'keydown',
              (pEvent) => onKey(pEvent, 'keydown'),
              false,
            );
            GodotEventListeners.add(
              elem,
              'keyup',
              (pEvent) => onKey(pEvent, 'keyup'),
              false,
            );
          }
          GodotEventListeners.add(
    ...
    var _godot_js_input_key_cb = function (pCallback, pCodePtr, pKeyPtr) {
      ...
      GodotEventListeners.add(
        GodotConfig.canvas,
        'keydown',
        GodotInput.onKeyEvent.bind(null, true),
        false,
      );
      GodotEventListeners.add(
        GodotConfig.canvas,
        'keyup',
        GodotInput.onKeyEvent.bind(null, false),
        false,
      );
    };
    ...
    function _godot_js_rtc_pc_local_description_set(
      ...
      ref.setLocalDescription({ sdp, type }).catch(function (error) {
    ...
    function _godot_js_webmidi_open_midi_inputs(
      pSetInputNamesCb,
      pOnMidiMessageCb,
      pDataBuffer,
      dataBufferLen,
    ...
    function _godot_js_wrapper_object_transfer_buffer(
      p_id,
      p_byte_arr,
      p_byte_arr_write,
      p_callback,
      ...
      const resizePackedByteArrayAndOpenWrite =
        GodotRuntime.get_func(p_callback);
    ...
    var GodotWebXR = {
      ...
      getLayer: () => {
        ...
        if (
          ...
          !GodotWebXR.gl_binding.createProjectionLayer
        ) {
          return null;
        }
    ...
    var __Z14godot_web_mainiPPc = (Module['__Z14godot_web_mainiPPc'] =
      makeInvalidEarlyAccess('__Z14godot_web_mainiPPc'));
    ...
    var __emwebxr_on_simple_event = (Module['__emwebxr_on_simple_event'] =
      makeInvalidEarlyAccess('__emwebxr_on_simple_event'));
    ...
    function assignWasmExports(wasmExports) {
      ...
      assert(
        typeof wasmExports['_Z14godot_web_mainiPPc'] != 'undefined',
        'missing Wasm export: _Z14godot_web_mainiPPc',
      );
      assert(
      ...
      assert(
        typeof wasmExports['_emwebxr_on_input_event'] != 'undefined',
        'missing Wasm export: _emwebxr_on_input_event',
      );
      assert(
        typeof wasmExports['_emwebxr_on_simple_event'] != 'undefined',
        'missing Wasm export: _emwebxr_on_simple_event',
      );
      assert(
      ...
      assert(
        typeof wasmExports['__funcs_on_exit'] != 'undefined',
        'missing Wasm export: __funcs_on_exit',
      );
      assert(
      ...
      assert(
        typeof wasmExports['_emscripten_timeout'] != 'undefined',
        'missing Wasm export: _emscripten_timeout',
      );
      assert(
